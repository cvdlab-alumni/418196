...
dpy = 52	 //distanza tra un pilastro e l'altro su y
dpz = 2         //distanza tra un pilastro e l'altro su z (cio�� lo spessore dei piani)
...
pillars1 = STRUCT([square_pillars_f1,long_square_pillars_f1,lone_round_pillar_f1,lone_square_pillar_f1]) 
...
tiny_square_pillar_f3 = T([2,3])([p+dpy+0.5,h*3+dpz*3])(tiny_square_pillar)	 //pilastro piccolo spostato al terzo piano, per comodit��

square_pillar_f3 = T([3])([h*3+dpz*3])(square_pillar)	 //pilastro quadrato spostato al terzo piano, per comodit��
...
building_pillars = STRUCT([pillars0, pillars1, pillars2, pillars3])
